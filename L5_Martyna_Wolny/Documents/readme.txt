...
* /Analisys_Data/weather.csv - plik zawiera kopię danych z oryginalnego pliku weather.txt; dane zostały oczyszczone w celu ułatwienia edycji
...
* /Analisys_Data/weather_2010.csv - plik zawiera dane pogodowe z roku 2010
** Pierwsza kolumna zawiera dane (id, rok, miesiąc, nazwa zmiennych)
** Następne kolumny zawierają wartości dla danego dnia w miesiącu

* /Analisys_Data/weather_2010_5_months.csv - plik zawiera dane pogodowe z roku 2010 dla pierwszych 5 miesięcy; dane zostały wyodrębione z pliku weather.csv
